...
export default function Datensicherung() {
  ...
  const handleFileChange = async (e) => {
    ...
    const confirmed = window.confirm(
      `⚠️ ACHTUNG: Alle vorhandenen Daten (Kunden, Lieferscheine, Rechnungen, Schmuckstücke) werden gelöscht und durch die Backup-Datei ersetzt!\n\nDatei: ${file.name}\n\nFortfahren?`
    );
    ...
    <div className="page-header">
      ...
      <div className="card" style={{ marginBottom: "32px" }}>
        ...
        <div className="card-body" style={{ padding: "24px" }}>
          ...
          <button
            ...
            disabled={exporting}
          >
            {exporting ? "Exportiere…" : "⬇️ Backup herunterladen"}
          </button>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="card-body" style={{ padding: "24px" }}>
          ...
          >
            {importing ? "Importiere…" : "📂 Backup-Datei wählen & importieren"}
          </label>
          <input
            id="import-file"
            ref={fileInputRef}
